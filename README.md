# 1 командный проект, который завершает блок изучения HTML и CSS/SASS.

Группа из 9 случайно подобранных людей за 5 дней совместной работы должны были сверстать и оформить
одностраничный лендинг для десктопа, таблетки и мобильных устройств. Адаптивная верстка. BEM
методология. Без кросс-браузерности. Использование Javascript для модальных окон. Оптимизация
растровых и векторных изображений под ретину.
